...
const ShopCard: FC = () => {
  ...
  function generateShopImageSliderItem(imageNumber) {
    return (
      <a
        href='!#'
        itemprop='image'
        className='shop-image-slider__item tns-item tns-slide-active'
        id={`tns1-item${imageNumber}`}
      >
        <img src={`../../../public/img/shopCard/${imageNumber}.jpg`} alt='' title='' />
      </a>
    );
  }
                ...
                <div class='tns-outer'>
                  ...
                  <div id='tns1-mw' class='tns-ovh'>
                    <div class='tns-inner' id='tns1-iw'>
                      ...
                      >
                        {[...Array(12)].map((_, index) => generateShopImageSliderItem(index + 1))}
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class='modal-dialog'>
                    <div class='modal-content'>
                      ...
                      <div class='modal-body'>
                        Пожалуйста, обратите внимание, что Вы не заполнили поле «Адрес эл.почты». В этом случае мы не
                        сможем сообщить результат рассмотрения Вашего обращения.{' '}
                      </div>
